...
const Navbar = () => {
    ...
    return (
        <header className="flex justify-between items-center pt-[10px] pr-5">
            <div className="flex items-center justify-center w-full max-w-[80vw] mx-auto box-border">
                <nav className="flex justify-between items-center w-full max-w-[80vw] mx-auto px-5 py-[10px]">
                    <div>
                        <span className="nav-text1 logo-text">
                            <strong>PRO</strong> makeup studio
                        </span>
                    </div>
<div className="menu bg-[#CABFB8] flex gap-[5px] text-center items-center justify-center w-[42px] h-[44px] p-0 rounded-full">
